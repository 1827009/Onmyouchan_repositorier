...
//元サイト
//https://kitsunegames.com/post/archived/2012/08/05/tutorial-custom-shaders-with-skinnedeffect-for-xna-4/
namespace SkinnedEffectExtension
{
    /// <summary>
    ...
    public class CustomSkinnedEffect : Effect, IEffectMatrices, IEffectLights, IEffectFog
    {
        ...
        /// </summary>
        void CacheEffectParameters(CustomSkinnedEffect cloneSource)
        {
