...
namespace onmyouchan.Entity
{
    ...
    class Player : Character
    {
            ...
            : base(EntityType.player, pos)
        {
            ...
            OhudaAttackAction += ControllManager.KeyCancel;
            HitogataThrowAction += ControllManager.LeftTrigger;
        ...
        {
            if (HitogataThrowAction()&&item1>0)
            {
                item1--;
                controlWeit = 1.8f;
                scoreDate.ItemCount++;
    ...
    class Ohuda : Entity
    {
        ...
        public override void Lord(EntityManager entityManager)
        {
            ...
            //thisEntityManager.LordEntity(new Particle(this, 1, thisEntityManager.thisGame.Content.Load<Texture2D>("O_Cube1_tx"),
            //    5,
            //    10,
            //    10,
            //    1,
    ...
    class OhudaAttack : Entity
    {
        ...
        public override void Lord(EntityManager entityManager)
        {
            ...
            modelStatus = new EntityStatus_Model(this, thisEntityManager.LordModel("O_Cube1"));
            base.Lord(entityManager);
        }
    }
    ...
    class Hitogata:Entity
    {
        ...
        public override void Lord(EntityManager entityManager)
        {
            ...
            hitStatus = new List<EntityStatus_Hit>();
            hitStatus.Add(new EntityStatus_Hit_Ball(this,20,HitPriorityGroup.attack));
            modelStatus = new EntityStatus_Model_Toon(this, entityManager.LordModel("GameModel\\fuda1"), "GameModel\\fudauv1");

            moveStatus.PhysicalStatus = new PhysicalParameter(0.2f, 0.0f);
    ...
    {
        public ItemObject(Vector3 pos):base(EntityType.attack)
        {
            position = pos;
        }
        public override void Lord(EntityManager entityManager)
    ...
    {
        public EntityStatus_Hit_Ball_ItemObject(Entity entity)
    ...
    {
        public EntityStatus_Hit_Ball_Item2Object(Entity entity)
            : base(entity, 30, HitPriorityGroup.attack)
        { }
    ...
    class EntityStatus_Model_Triangle : EntityStatus_Model
    {
            ...
            : base(entity)
        {
            ...
            effect.Parameters["MyTexture"].SetValue(thisEntity.ThisEntityManager.thisGame.Content.Load<Texture2D>("GameUI\\IMG_2302"));
        }
    ...
    class EntityStatus_Hit_Triangle_Note : EntityStatus_Hit_Triangle
    {
        ...
        public EntityStatus_Hit_Triangle_Note(Entity entity, Vector2 pos1, Vector2 pos2, Vector2 pos3)
            : base(entity, pos1, pos2, pos3,HitPriorityGroup.attack)
        {
        }
