...
namespace onmyouchan
{
    ...
    class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public static WaveBank wave;
        public static SoundBank sound;
        public static WaveBank seWave;
        public static SoundBank seSound;
        ...
        public OptionComponent optionComponent;
        ...
        protected override void Initialize()
        {
            ...
            audio = new AudioEngine("Content\\Sound\\onmyouchanAudio.xgs");
            wave = new WaveBank(audio, "Content\\Sound\\WaveBank.xwb");
            sound = new SoundBank(audio, "Content\\Sound\\SoundBank.xsb");
            seWave = new WaveBank(audio, "Content\\Sound\\SeWaveBank.xwb");
            seSound = new SoundBank(audio, "Content\\Sound\\SeSoundBank.xsb");
